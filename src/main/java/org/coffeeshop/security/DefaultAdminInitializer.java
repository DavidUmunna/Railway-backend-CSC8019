...
public class DefaultAdminInitializer implements CommandLineRunner {
    ...
    public DefaultAdminInitializer(StaffRepository staffRepository, PasswordEncoder passwordEncoder) {
    ...
    public void run(String... args) {
        ...
        logger.info("Bootstrapped default admin user '{}'. Change its password after first login.", username);
    }
}
