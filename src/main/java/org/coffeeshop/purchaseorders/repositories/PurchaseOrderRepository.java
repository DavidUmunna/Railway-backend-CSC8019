...
/**
 * Spring Data JPA repository for {@link org.coffeeshop.purchaseorders.models.PurchaseOrder} entities.
...
public interface PurchaseOrderRepository extends JpaRepository<PurchaseOrder, Long> {
    ...
    /**
     * Finds all completed purchase orders whose requested pickup time has passed
     * the given cutoff, indicating that the 15-minute collection grace period has expired.
     * Matches orders from previous days, or from today with a pickup time before the cutoff.
     *
     * @param expiryTime the cutoff time; completed orders with pickupTime before this
     *                    on today's date are considered expired
     * @return a list of uncollected purchase orders past the grace period
     */
    @Query("SELECT o FROM PurchaseOrder o WHERE o.orderStatus = 'COMPLETED' "
