...
/**
 * Service layer for menu item type operations.
 * Provides read-only access to item types (size variants) by ID or as a full list.
...
public class MenuItemTypeService {
     ...
     * @throws jakarta.persistence.EntityNotFoundException if no menu item type exists with the given ID
     */
